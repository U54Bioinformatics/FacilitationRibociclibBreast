...
# Extract likelihood for WAIC comparison
...
load(file="/Users/jason/Dropbox/Vince data/Fitted Model Params/Bayeian Ribo Params/Life history full/Ribo_fit_Subclonal compModel.Rdata")
pars_guess <- c(
  r_N=exp(0),
  r_A=exp(0),
