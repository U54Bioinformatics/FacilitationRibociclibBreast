...
for(i in 1:nt){for(j in 1:nStatesObs){ lnY[i,j] ~ normal( log(y_hat[i,j] + y_hat[i,j+nStatesObs] + 1.0 ) , sigma ); }}
...
load(file="/Users/jason/Dropbox/Vince data/Fitted Model Params/Bayeian Ribo Params/Life history full/Ribo_fit_PlasticityModelRandSwitch.Rdata")
pars_guess <- c(
  r_N=exp(0),
  r_A=exp(0),
