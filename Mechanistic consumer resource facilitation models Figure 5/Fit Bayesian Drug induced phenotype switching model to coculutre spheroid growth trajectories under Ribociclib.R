...
//integrate ode
y_hat = integrate_ode_bdf(dY_funStan, inits, t0, tObs, params, x_r, x_i , 1e-2, 1e-1,1e2);//1e-6, 1e-1, 1e3 ) ;        
}
model {
...
load(file="/Users/jason/Dropbox/Vince data/Fitted Model Params/Bayeian Ribo Params/Life history full/Ribo_fit_PlasticityModel.Rdata")
pars_guess <- c(
  r_N=exp(0),
  r_A=exp(0),
