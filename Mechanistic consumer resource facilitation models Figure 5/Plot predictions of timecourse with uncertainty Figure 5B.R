...
# Load the full fitted estradiol mediated facilitation model results after running: Full Estradiol mediated facilitation model Fit Bayesian Facilitation asymmetric 3D to coculutre spheroid growth trajectories under Ribociclib.R 
...
# Summarised data to that can be loaded after running the fitting code in :Full Estradiol mediated facilitation model Fit Bayesian Facilitation asymmetric 3D to coculutre spheroid growth trajectories under Ribociclib.R
...
ModelPreds <- mean_credibleregion[mu>10]
ObservedData <- fit.dd[value>0]
save( ModelPreds, ObservedData  ,file="/Users/jason/Dropbox/Cancer_pheno_evo/data/Lab Facilitation/Fig5Bdata.RData")
