...
#rho <- 1
#alpha <- 2
luinter<-expand.grid(rho=1,alpha= 1# 10^(-3:2)
                     ,phi=1, omega=1)# seq(0,1,length=5))
...
luinter<-expand.grid(rho=1,alpha= 1,mu=c(1:max_mu),nu_A=nu_A,nu_N=nu_N# 10^(-3:2)
                     ,phi=1)# seq(0,1,length=5))
